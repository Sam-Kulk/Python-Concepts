...
print(List1[4:2]) # Last index-1
# I will get again a list as an output.

# Note: Here I will not get the index error, basically withing the specified range, whatever
# elements matches, the result will be provided, not matched or not present will be ignored & an empty list will be returned as output.
# print(List1[-10:23])
print(List1[:3])
print(List1[0:])
